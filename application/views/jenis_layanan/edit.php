          ...
          <form action="" method="post" autocomplete="off">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" name="nama" class="form-control <?= form_error('nama') ? 'is-invalid' : '' ?>" value="<?= $jenis_layanan['nama']; ?>">
              ...
              <div class="form-group">
                ...
                <select name="tipe" class="form-control">
                  <?php foreach ($tipe as $s) : ?>
                    <option value="<?= $s['nama']; ?>" <?= $s['nama'] == $jenis_layanan['tipe'] ? 'selected' : ''; ?>><?= $s['nama']; ?></option>
                  <?php endforeach; ?>
                </select>
              </div>
