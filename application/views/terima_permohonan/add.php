          ...
          <form action="" method="post" autocomplete="off">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="asal" class="form-control <?= form_error('asal') ? 'is-invalid' : '' ?>" value="<?= set_value('asal'); ?>">
                <div class="invalid-feedback">
                  <?= form_error('asal') ?>
                </div>
              </div>
              <div class="form-group">
                ...
                <textarea name="perihal" class="form-control <?= form_error('perihal') ? 'is-invalid' : '' ?>" cols="30" rows="3"><?= set_value('perihal'); ?></textarea>
                <div class="invalid-feedback">
                  <?= form_error('perihal') ?>
                </div>
              </div>
